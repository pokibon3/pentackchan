...
static void dabble_joypad_control()
{
    ...
    float left_speed = (y_axis + x_axis) * JOY_FACTOR; // Left side speed
    float right_speed = (y_axis - x_axis) * JOY_FACTOR; // Right side speed
    ...
    Serial.printf("# Dabble JoyPad Control: X=%d, Y=%d | Left=%.0f, Right=%.0f | PWM: FL=%d, FR=%d, RL=%d, RR=%d\n", 
